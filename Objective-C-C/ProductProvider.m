...
-(void) requestNextPage {
    ...
    [manager GET:@"http://52.198.40.72/patissier/api/v1/products?paging=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI1OTI1MWNiMTQ3ZDUzYjA4NWNhMDc2NTQiLCJsaW1pdCI6MTAsIm9mZnNldCI6MTAsInR5cGUiOiJwYWdlIiwidmVyc2lvbiI6IjEuMCJ9.tIGvrPtticeV7ssvpy5p0_jMOHjTNYqNfJaqdOUKiTs"
      parameters: nil progress: nil success:^(NSURLSessionTask *task, id responseObject) {
          ...
          dispatch_async(dispatch_get_main_queue(), ^(void) {
              ...
              [self.delegate didGetNextPageProducts: fetchedProducts];
